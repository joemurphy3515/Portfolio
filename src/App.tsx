          ...
          <div className="cards-stack">
            <div className="feature-card card-pm">
              ...
              <p>
                ...
                bridge both roles to ensure ideas move seamlessly from concept
                to customer impact.
              </p>
              <p className="small-text">
                My experience spans defining product vision, aligning
                stakeholders, and validating user needs while translating
                strategy into clear requirements.
              </p>
            </div>
            ...
            <div className="feature-card card-eng">
              ...
              <p className="small-text">
                ...
                integrating third-party APIs, and building serverless backend
                services.
              </p>
            </div>
            ...
            {projects.map((project, index) => (
              <div className="project-card" key={index}>
                ...
                <p className="project-desc">
                  Description placeholder for the project goes here explaining
